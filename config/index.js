export const config = {
  ...
  USERS: [
    {
      ...
      id: "odGtg54BitCBohcWITL5Ck39E4QA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "5ZejJ6e13ivDS5X7RkKhltAz-1u8eyV-tg1pSW0YCqY",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "南京",
      ...
      festivals: [
        ...
        //{"type": "*生日", "name": "小宝", "year": "1996", "date": "01-01"},
  ...
  CALLBACK_TEMPLATE_ID: "EgtS53dFvClMK8wtCR2V5pQDNtw4PAw4bm4VAHJI9jA",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "odGtg5-pfC7GwI1JS-ftz0c9l5h8",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
